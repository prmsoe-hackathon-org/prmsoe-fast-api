...
INSERT INTO contacts (id, user_id, full_name, linkedin_url, raw_role, company_name, status, strategy_tag, draft_message, created_at) VALUES
  (c41, uid, 'Mert Gulsun', 'https://www.linkedin.com/in/mert-gulsun', 'Senior Associate Consultant', 'Bain & Company', 'DRAFT_READY', 'VALIDATION_ASK',
   ...
   now() - interval '2 days'),
  (c42, uid, 'Umar Ghani', 'https://www.linkedin.com/in/umarghani1', 'Incoming Engineer Intern', 'Qualcomm', 'DRAFT_READY', 'INDUSTRY_TREND',
